...
public class EqzhongyaoController {
    //添加日志器
    ...
    static{
        ...
        InputStream is = EqzhongyaoController.class.getClassLoader().getResourceAsStream(resource);
    ...
    public void getDistTongyongmingcheng(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistTongyongmingcheng");
        sqlSession.close();
    ...
    public void getDistYingwenming(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistYingwenming");
        sqlSession.close();
    ...
    public void getDistLaiyuan(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistLaiyuan");
        sqlSession.close();
    ...
    public void getDistYuanliao(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistYuanliao");
        sqlSession.close();
    ...
    public void getDistZhuangtai(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistZhuangtai");
        sqlSession.close();
    ...
    public void getDistLeibie001(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistLeibie001");
        sqlSession.close();
    ...
    public void getDistLeibie002(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistLeibie002");
        sqlSession.close();
    ...
    public void getDistLeibie003(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistLeibie003");
        sqlSession.close();
    ...
    public void getDistGuanlileibie(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistGuanlileibie");
        sqlSession.close();
    ...
    public void getDistChufangyao(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistChufangyao");
        sqlSession.close();
    ...
    public void getDistChengfen(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistChengfen");
        sqlSession.close();
    ...
    public void getDistBiaozhunguidingguige(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistBiaozhunguidingguige");
        sqlSession.close();
    ...
    public void getDistBiaozhunwaiguige(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistBiaozhunwaiguige");
        sqlSession.close();
    ...
    public void getDistShiyongduixiang(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistShiyongduixiang");
        sqlSession.close();
    ...
    public void getDistYongtu(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistYongtu");
        sqlSession.close();
    ...
    public void getDistXianlianghuoxiuyao(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistXianlianghuoxiuyao");
        sqlSession.close();
    ...
    public void getDistPizhunshijian(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistPizhunshijian");
        sqlSession.close();
    ...
    public void getDistBiaozhunyange(HttpServletResponse response,
        ...
        List<String> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getDistBiaozhunyange");
        sqlSession.close();
    ...
    public void selectSer(HttpServletResponse response,
        ...
        PageHelper.startPage(page,rows);
        List<Med> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getMedByAll",queryMed);
        sqlSession.close();
    ...
    public void delSerById(HttpServletRequest request, HttpServletResponse response,
        ...
        for(int i = 0;i<ids.length;i++){
            try {
                sqlSession.delete("com.equipments.management.mapper.zhongyaoMedMapper.removeMedById",ids[i]);
                ...
                if(file != null){
                    ...
                    if((myFileName.trim())!=""){
                        ...
                        try {
                            ...
                            //设置根据ID设置上传文件名称
                            sqlSession.update("com.equipments.management.mapper.zhongyaoMedMapper.updateMed",med);
                        } catch (IOException e) {
                            e.printStackTrace();
                            return "wrong";
                        }
    ...
    public void updateMedsByIds(HttpServletResponse response,
        ...
        int count = sqlSession.selectOne("com.equipments.management.mapper.zhongyaoMedMapper.countById");
        ...
        List<Med> medList = sqlSession.selectList("com.equipments.management.mapper.zhongyaoMedMapper.getMedByAll");
        sqlSession.close();
        PagedResult<Med> pd = BeanUtil.toPagedResult(medList);
    ...
    public void downloadExcel(HttpServletRequest request,
        ...
        String filename = "zhongyao" + df.format(new Date()) +".xls";
        response.setContentType("text/html;charset=UTF-8");
        POIUtil.test(response,"zhongyao",headers,medList,filename);
