...
public class Patientappli001 {
    ...
    private List<Inspmethod001> inspmethod001List;

    private List<Collectanatomy001> collectanatomy001List;

    private List<Acceptsample001> acceptsample001List;

    private Pathologyreview001 pathologyreview001;
    ...
    public List<Inspmethod001> getInspmethod001List() {
        return inspmethod001List;
    }

    public void setInspmethod001List(List<Inspmethod001> inspmethod001List) {
        this.inspmethod001List = inspmethod001List;
    }

    public List<Collectanatomy001> getCollectanatomy001List() {
        return collectanatomy001List;
    }

    public void setCollectanatomy001List(List<Collectanatomy001> collectanatomy001List) {
        this.collectanatomy001List = collectanatomy001List;
    }

    public List<Acceptsample001> getAcceptsample001List() {
        return acceptsample001List;
    }

    public void setAcceptsample001List(List<Acceptsample001> acceptsample001List) {
        this.acceptsample001List = acceptsample001List;
    }

    public Pathologyreview001 getPathologyreview001() {
        return pathologyreview001;
    }

    public void setPathologyreview001(Pathologyreview001 pathologyreview001) {
        this.pathologyreview001 = pathologyreview001;
    }
    ...
    public String toString() {
        return "Patientappli001{" +
                ...
                ", inspmethod001List=" + inspmethod001List +
                ", collectanatomy001List=" + collectanatomy001List +
                ", acceptsample001List=" + acceptsample001List +
                ", pathologyreview001=" + pathologyreview001 +
                ", drawnum=" + drawnum +
                ", productsnum=" + productsnum +
                '}';
    }

    public Patientappli001(){
    }
}
