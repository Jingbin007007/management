              ...
              <div class="col-md-12">
                <div class="widget">
                  <div class="widget-head">
                    <div class="pull-left">扫描记录列表</div>
                        ...
                        <div class="widget-content">
                          <form id="formSearch001" class="form-horizontal">
                            <div class="form-group" style="margin-top:15px">
                              ...
                              <div class="col-sm-2">
                                <select id="txt_search_patientdiagkind" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请选择切片类别'></select>
                              </div>
                              <label class="control-label col-sm-1" for="txt_search_reviewstatus">打印状态</label>
                              <div class="col-sm-2">
                                <select id="txt_search_reviewstatus" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请选择制片状态'></select>
                              </div>
                            ...
                            <div class="form-group" style="margin-top:15px">
                              ...
                              <label class="control-label col-sm-1" for="datetimepicker1">诊断日期</label>
                              <div id="datetimepicker1" class="input-append col-sm-2">
                                <input data-format="yyyy-MM-dd" type="text" class="form-control dtpicker" id="txt_search_reviewdate001">
                                <span class="add-on">
                              ...
                              <div id="datetimepicker2" class="input-append col-sm-2">
                                <input data-format="yyyy-MM-dd" type="text" class="form-control dtpicker" id="txt_search_reviewdate002">
                                <span class="add-on">
                                  <i data-time-icon="icon-time" data-date-icon="icon-calendar" class="btn btn-info btn-lg"></i>
                                </span>
                              </div>
...
<div class="modal fade report" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="vertical-align-center" role="document" style="left:10%">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">病例诊断报告</h3>
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" role="form">
          <div class="form-group">
            <div class="row">
              <label class="col-lg-1 control-label"> 姓&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp名 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_patientname" readonly>
              </div>
              <label class="col-lg-1 control-label"> 性&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp别 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_patientgender" readonly>
              </div>
              <label class="col-lg-1 control-label"> 年&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp龄 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_patientage" readonly>
              </div>
              <label class="col-lg-1 control-label"> 既往病理号 </label>
              <div class="col-lg-2">
            ...
            <br/>
            <div class="row">
              <label class="col-lg-1 control-label"> 病&nbsp&nbsp理&nbsp&nbsp号 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_applino" readonly>
              </div>
              <label class="col-lg-1 control-label"> 院&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp别 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_inspunitname" readonly>
              </div>
              <label class="col-lg-1 control-label"> 科&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp别 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_inspdepartid" readonly>
              </div>
              <label class="col-lg-1 control-label"> 床&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp号 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_bedid" readonly>
              </div>
            </div>
            <br/>
            <div class="row">
              <label class="col-lg-1 control-label"> 住&nbsp&nbsp院&nbsp&nbsp号 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_hospitalizetionid" readonly>
              </div>
              <label class="col-lg-1 control-label"> 门&nbsp&nbsp诊&nbsp&nbsp号 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_outpatientid" readonly>
              </div>
              <label class="col-lg-1 control-label"> 送检医师 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_inspdoctid" readonly>
              </div>
              <label class="col-lg-1 control-label"> 送检日期 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_inspdate" readonly>
              </div>
            </div>
            <br/>
            <div class="row">
              <label class="col-lg-1 control-label"> 临床诊断 </label>
              <div class="col-lg-2">
                <input type="text" class="form-control" placeholder="Input Box" id="txt_result_diagnosispathology" readonly>
              </div>
            </div>
          </div>
        </form>
        ...
        <div class="content zhenduan">
          <h4>病例诊断</h4>
          <br/>
          <div class="row">
            <label class="col-lg-1 control-label"> 肉眼所见 </label>
            <div class="col-lg-11">
              <textarea class="form-control" rows="2" placeholder="Textarea" id="txt_result_visualobservation" readonly></textarea>
            </div>
          </div>
        <br/>
          <div class="row">
            <label class="col-lg-1 control-label"> 镜下所见 </label>
            <div class="col-lg-11">
              <textarea class="form-control" rows="2" placeholder="Textarea" id="txt_result_diagnosismicroscope" readonly></textarea>
            </div>
          </div>
          <br/>
          <div class="row">
            <label class="col-lg-1 control-label"> 特殊检查 </label>
            <div class="col-lg-11">
              <textarea class="form-control" rows="2" placeholder="Textarea" id="txt_result_diagnosisspecial" readonly></textarea>
            </div>
          </div>
          <br/>
          <div class="row">
            <label class="col-lg-1 control-label"> 冰冻诊断 </label>
            <div class="col-lg-11">
              <textarea class="form-control" rows="2" placeholder="Textarea"  id="txt_result_frozendiagnosisspecial" readonly></textarea>
            </div>
          </div>
          <br/>
          <div class="row">
            <label class="col-lg-1 control-label"> 会诊意见 </label>
            <div class="col-lg-11">
              <textarea class="form-control" rows="2" placeholder="Textarea" id="txt_result_consultation" readonly></textarea>
            </div>
          </div>
          <br/>
          <div class="row">
            <label class="col-lg-1 control-label"> AI诊断 </label>
            <div class="col-lg-11">
              <textarea class="form-control" rows="2" placeholder="Textarea" id="txt_result_aidiagnosis" readonly></textarea>
            </div>
          </div>
          <br/>
          <div class="row">
            <label class="col-lg-1 control-label"> 病理诊断 </label>
            <div class="col-lg-11">
              <textarea class="form-control" rows="2" placeholder="Textarea" id="txt_result_diagnosis" readonly></textarea>
            </div>
          </div>
          <br/>
        </div>
