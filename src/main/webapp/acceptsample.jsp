...
<head>
  ...
  <script src="js/acceptsample.js"></script>
  ...
  <div class="mainbar">
    ...
    <div class="page-head">
      ...
      <div class="bread-crumb pull-right">
        ...
        <a href="#" class="bread-current">标本列表</a>
      </div>
                      ...
                      <div class="widget">
                        ...
                        <div class="widget-content">
                          <form id="formSearch001" class="form-horizontal">
                            ...
                            <div class="form-group" style="margin-top:15px">
                              <label class="control-label col-sm-1" for="txt_search_patientdiagkind">检查方法</label>
                              <div class="col-sm-3">
                                <select id="txt_search_patientdiagkind" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请选择检查方法'></select>
                              </div>
                              <label class="control-label col-sm-1" for="txt_search_sampleresult">标本状态</label>
                              <div class="col-sm-3">
                                <select id="txt_search_sampleresult" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请选择标本状态'></select>
                              </div>
                            </div>
