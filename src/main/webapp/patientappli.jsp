                        ...
                        <div class="widget-content">
                          <form id="formSearch001" class="form-horizontal">
                            <div class="form-group" style="margin-top:15px">
                              ...
                              <div class="col-sm-3">
                                <select id="txt_search_inspmethod" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请输入检查方法'></select>
                              </div>
                            </div>
                            <div class="form-group" style="margin-top:15px">
                              ...
                              <label class="control-label col-sm-1" for="txt_search_inspdepartid">送检科室</label>
                              <div class="col-sm-3">
                                <select id="txt_search_inspdepartid" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请输入送检科室'></select>
                              </div>
                            ...
                            <div class="form-group" style="margin-top:15px">
                              ...
                              <label class="control-label col-sm-1" for="datetimepicker1">送检日期</label>
