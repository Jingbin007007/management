...
<head>
  ...
  <script src="js/scan001.js"></script>
                        ...
                        <div class="widget-content">
                          <form id="formSearch001" class="form-horizontal">
                            <div class="form-group" style="margin-top:15px">
                              ...
                              <label class="control-label col-sm-1" for="txt_search_productdesc">切片类别</label>
                              <div class="col-sm-3">
                                <select id="txt_search_productdesc" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请选择切片类别'></select>
                              </div>
                              <label class="control-label col-sm-1" for="txt_search_scanstatus">扫描状态</label>
                              <div class="col-sm-3">
                                <select id="txt_search_scanstatus" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请选择制片状态'></select>
                              </div>
                            </div>
                            <div class="form-group" style="margin-top:15px">
                  ...
                  <div class="widget-content">
                    <div class="panel-body" style="padding-bottom:0px;">
                      <div id="toolbar001" class="btn-group">
                        <button id="btn_save001" type="button" class="btn btn-default">
                          <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>保存
                        </button>
                      </div>
