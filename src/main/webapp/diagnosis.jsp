                        ...
                        <div class="widget-content">
                          <form id="formSearch001" class="form-horizontal">
                            <div class="form-group" style="margin-top:15px">
                              <label class="control-label col-sm-1" for="txt_search_diagnosisstatus">阅片状态</label>
                              <div class="col-sm-2">
                                <select id="txt_search_diagnosisstatus" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请选择切片类别'></select>
                              </div>
                              <label class="control-label col-sm-1" for="txt_search_consultationif">是否会诊</label>
                              <div class="col-sm-2">
                                <select id="txt_search_consultationif" data-first-option="false" data-live-search="true" class="selectpicker form-control show-tick" title='请选择制片状态'></select>
                              </div>
