...
<head>
  ...
  <script src="js/userFace001shengyao.js"></script>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li><a href="userFace002shengyao.jsp" class="open"><i class="icon-magic"></i> 生药筛选</a></li>
        </ul>
    </div>
                        ...
                        <div class="widget-content">
                          <form id="formSearch001" class="form-horizontal">
                            ...
                            <div class="form-group" style="margin-top:15px">
                              ...
                              <label class="control-label col-sm-1" for="txt_search_jianyanxiangmu">检查项目</label>
                              <div class="col-sm-3">
                                <input type="text" class="form-control" id="txt_search_jianyanxiangmu">
                              </div>
                            </div>
    ...
    $("#input-b9").fileinput({
        ...
        var opt = {
            ...
            query:{
                ...
                jianyanxiangmu:$("#txt_search_jianyanxiangmu").val(),
